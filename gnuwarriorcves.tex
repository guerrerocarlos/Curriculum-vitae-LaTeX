...
\NewWorkExperience{oct.2011--Actualmente}{\textbf{Brightcomms} $\cdotp$}{El Salvador.}
...
\vspace{1em}
\Description{\MarginDate{Websites Desarrollados}\textsc{\href{Http://Tienditas.net/}{\textbf{Http://Tienditas.net/}} } \newline Plataforma de creación automatica de tiendas online. Integración con Facebook y Twitter.\newline \textit{librerias: Django,jQuery} $\cdotp$\ \ 2011\newline}
